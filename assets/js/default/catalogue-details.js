            ...
            success: function (data, textStatus, request) {
                if (data.items.length > 0) {
                    ...
                    data.items.forEach(element => {
                        ...
                        a += `</div><div class="sb-g-col-xs-3 sb-g-col-md-3 sb-g-col-lg-3 sb-g-col-xl-3 sb-g-col-xxl-3 sb-g-col-xxxl-3"> <img src="/assets/diksha-mission/catalogue/Shape.svg" onerror="this.src='/assets/diksha-mission/catalogue/Shape.svg'" class="icon" alt="Shape Image"> </div></div><div class="sb-g"> <div class="sb-g-col-xs-12 sb-g-col-md-12 sb-g-col-lg-12 sb-g-col-xl-12 sb-g-col-xxl-12 sb-g-col-xxxl-12"> <a class="view-dictionary-link dictionary-popup-open" data-id="${element.id}" title="View Dictionary"><img src="/assets/diksha-mission/catalogue/dict.svg" onerror="this.src='/assets/diksha-mission/catalogue/dict.svg'" class="mr-8" alt="Dictionary Image"></a> </div></div><hr/> <div class="sb-g"> <div class="sb-g-col-xs-9 sb-g-col-md-9 sb-g-col-lg-9 sb-g-col-xl-9 sb-g-col-xxl-9 sb-g-col-xxxl-9"> <h5>Download</h5><a href="${element.link}${moment(c_2).format("YYYY-MM-DD")}.csv" class="cd-button download-csv" download> CSV </a> </div><div class="sb-g-col-xs-3 sb-g-col-md-3 sb-g-col-lg-3 sb-g-col-xl-3 sb-g-col-xxl-3 sb-g-col-xxxl-3"> </div></div></div></div>`;
                    });
