const languageTranslations = {
    "en": {
        ...
        "practiceContentDesc": "Access unlimited practice content with their solutions",
    ...
    "as": {
        ...
        "compleateCoverageDesc": "সকলো বোৰ্ড, শ্ৰেণী আৰু বিষয় সামৰি লোৱা সম্পূৰ্ণ কে-১২ অধ্যয়ন সামগ্ৰী প্ৰৱেশ কৰক",
    ...
    "bn": {
        ...
        "jaduiPitaraDesc":"খেলনা, গেম, পাজল, পুতুল, পোস্টার, ফ্ল্যাশকার্ড ইত্যাদি সহ ভিত্তি পর্যায়ের বিষয়বস্তু।",    
        "adultEducation": "শিক্ষা সবার জন্য",
        "adultEducationDesc": "নাগরিকদের জন্য মৌলিক সাক্ষরতা এবং সংখ্যাজ্ঞান, সমালোচনামূলক জীবন দক্ষতা প্রদান করা",
        "vocationEducation": "বৃত্তিমূলক শিক্ষা",
        "vocationEducationDesc": "সাধারণ শিক্ষার সাথে বৃত্তিমূলক প্রশিক্ষণের একীকরণের দিকে মনোনিবেশ করার উদ্যোগ",
        "virtualLab": 'ভার্চুয়াল ল্যাব',
        "virtualLabDesc": "প্রকৃত পরীক্ষাগার অভিজ্ঞতা উন্নত করতে শিক্ষার্থীদের জন্য ভার্চুয়াল পরীক্ষাগার অ্যাক্সেস",
        "compreLearning": "ব্যাপক শিক্ষা",
        "foundationalsecondary" :  "ভিত্তি থেকে মাধ্যমিকের জন্য",
        "compleateCoverage": "সম্পূর্ণ কে-১২ কভারেজ",
        "compleateCoverageDesc": "সমস্ত বোর্ড, ক্লাস এবং বিষয়গুলি জুড়ে সম্পূর্ণ কে-১২ অধ্যয়নের উপাদান অ্যাক্সেস করুন",
       " practiceContent": "অনুশীলনের বিষয়বস্তু",
    ...
    "gu": {
       ...
       "practiceContent": "પ્રેક્ટિસ સામગ્રી",
        "practiceContentDesc" :"તેમના ઉકેલો સાથે અમર્યાદિત પ્રેક્ટિસ સામગ્રીનો ઉપયોગ કરો.",
    ...
    "hi": {
       ...
       "practiceContent": "अभ्यास सामग्री",
        "practiceContentDesc" :"उनके समाधानों के साथ असीमित अभ्यास सामग्री का उपयोग करें।",
    ...
    "kn": {
       ...
       "practiceContent": "ಅಭ್ಯಾಸ ಸಾಮಗ್ರಿ",
        "practiceContentDesc" :"ಅವುಗಳ ಪರಿಹಾರಗಳೊಂದಿಗೆ ಅನಿಯಮಿತ ಅಭ್ಯಾಸ ಸಾಮಗ್ರಿಗಳನ್ನು ಬಳಸಿ.",
    ...
    "mr": {
       ...
       "practiceContent": "सराव सामग्री",
        "practiceContentDesc" :"त्यांच्या उपायांसह अमर्यादित सराव सामग्रीमध्ये प्रवेश करा",
    ...
    "or": {
       ...
       "practiceContent": "ଅଭ୍ଯ଼ାସ ସାମଗ୍ରୀ",
        "practiceContentDesc" :"ସେମାନଙ୍କ ସମାଧାନ ସହିତ ଅସୀମିତ ଅଭ୍ଯ଼ାସ ସାମଗ୍ରୀ ବ୍ଯ଼ବହାର କରନ୍ତୁ।",
    ...
    "pa": {
        ...
        "aboutDikshaHeading" : "DIKSHA - ਇੱਕ ਰਾਸ਼ਟਰ, ਇੱਕ ਡਿਜੀਟਲ ਮੰਚ।",
        "viewMore" : "ਹੋਰ ਵੇਖੋ",
       ...
       "practiceContent": "ਅਭਿਆਸ ਸਮੱਗਰੀ",
        "practiceContentDesc" :"ਉਹਨਾਂ ਦੇ ਹੱਲਾਂ ਨਾਲ ਬੇਅੰਤ ਅਭਿਆਸ ਸਮੱਗਰੀ ਦੀ ਵਰਤੋਂ ਕਰੋ।",
        ...
        "aboutDescription" : "DIKSHA(ਗਿਆਨ ਸਾਂਝਾ ਕਰਨ ਲਈ ਡਿਜੀਟਲ ਬੁਨਿਆਦੀ ਢਾਂਚਾ) ਸਕੂਲ ਸਿੱਖਿਆ ਲਈ ਇੱਕ ਰਾਸ਼ਟਰੀ ਮੰਚ ਹੈ, ਜੋ ਸਿੱਖਿਆ ਮੰਤਰਾਲੇ (ਐੱਮ. ਓ. ਈ.), ਭਾਰਤ ਸਰਕਾਰ ਦੀ ਸਰਪ੍ਰਸਤੀ ਹੇਠ ਰਾਸ਼ਟਰੀ ਸਿੱਖਿਆ ਖੋਜ ਅਤੇ ਸਿਖਲਾਈ ਪਰਿਸ਼ਦ (ਐੱਨ. ਸੀ. ਈ. ਆਰ. ਟੀ.) ਦੀ ਇੱਕ ਪਹਿਲ ਹੈ। ਭਾਰਤ ਦੇ ਮਾਣਯੋਗ ਉਪ ਰਾਸ਼ਟਰਪਤੀ-ਸ਼੍ਰੀ ਐੱਮ. ਵੈਂਕਈਆ ਨਾਇਡੂ ਦੁਆਰਾ 2017 ਵਿੱਚ ਸ਼ੁਰੂ ਕੀਤੀ ਗਈ 'ਦੀਕਸ਼ਾ ਨੂੰ ਸੀ. ਬੀ. ਐੱਸ. ਈ. ਸਮੇਤ ਲਗਭਗ ਸਾਰੇ ਰਾਜਾਂ, ਕੇਂਦਰ ਸ਼ਾਸਿਤ ਪ੍ਰਦੇਸ਼ਾਂ, ਕੇਂਦਰੀ ਖੁਦਮੁਖਤਿਆਰ ਸੰਸਥਾਵਾਂ/ਬੋਰਡਾਂ ਦੁਆਰਾ ਅਪਣਾਇਆ ਗਿਆ ਹੈ।"
    },
    "ta": {
       ...
       "practiceContent": "பயிற்சி பொருள்",
        "practiceContentDesc" :"அவற்றின் தீர்வுகளுடன் வரம்பற்ற பயிற்சி பொருட்களைப் பயன்படுத்தவும்.",
    ...
    "te": {
        ...
        "login" : "లాగిన్",
        "getAppDesc": "DIKSHA అప్లికేషన్ ప్లే స్టోర్ మరియు యాప్ స్టోర్లో అందుబాటులో ఉంది, మీరు దానిని డౌన్లోడ్ చేయడానికి క్యూఆర్ కోడ్ను కూడా స్కాన్ చేయవచ్చు.",
        ...
        "dikshaGlance" : "ఒక చూపులో DIKSHA",
        "missionVision":"మిషన్ & విజన్",
        "footerBottom":"© 2024-కాపీరైట్ DIKSHA. అన్ని హక్కులు రిజర్వ్ చేయబడ్డాయి. NeGD | MeitY గవర్నమెంట్ ఆఫ్ ఇండియా® 2024 DIKSHA ద్వారా ఆధారితం",
        "nipunBharat": "నిపున్ భారత్",
        "userDesc" : "DIKSHA ను దేశవ్యాప్తంగా అభ్యాసకులు మరియు ఉపాధ్యాయులు యాక్సెస్ చేయవచ్చు మరియు ప్రస్తుతం 36 భారతీయ భాషలకు మద్దతు ఇస్తుంది.",
        "aboutGlanceStudent" : "విద్యార్థి",
        "aboutGlanceTeacher" : "శిక్షకుడు",
        ...
        "participateQuiz" : "క్విజ్‌లలో పాల్గొనండి",
        "participateQuizDesc": "క్విజ్‌లు నేర్చుకోవడాన్ని సరదాగా చేస్తాయి మరియు విద్యార్థులు మెరుగ్గా పని చేయడంలో సహాయపడతాయి"
    ...
    "ur": {
        ...
        "practiceContent": "مشق مواد",
        "practiceContentDesc" :"حل کے ساتھ لامحدود پریکٹس مواد تک رسائی حاصل کریں۔",
